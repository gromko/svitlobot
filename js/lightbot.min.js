...
b.WhileInstruction;lightBot.bot.instructions=b})();(function(){var a={},b=null,d={x:0,y:0},c=null,g=null,j=null;a.loadMaps=function(){$.ajax({url:"maps/maps.txt",dataType:"json",success:function(a){b=a},error:function(){b=lightBot.map.backup}})};a.loadMap=function(a){if(b){j=a;lightBot.bot.init(b[a].direction,b[a].position);g=b[a].medals;d.x=b[a].map[0].length;d.y=b[a].map.length;c=Array(d.x);for(h=0;h<d.x;h++)c[h]=Array(d.y);for(var i=0,h=0;h<b[a].map.length;h++)for(var f=0;f<b[a].map[h].length;f++)switch(b[a].map[h][f].t){case "b":c[f][b[a].map.length-
h-1]=new lightBot.Box(b[a].map[h][f].h,f,b[a].map.length-h-1);break;case "l":c[f][b[a].map.length-h-1]=new lightBot.LightBox(b[a].map[h][f].h,f,b[a].map.length-h-1);i++;break;default:console.error("Map contains unsupported element: "+b[a].map[h][f].t),c[f][b.map.length-h-1]=new lightBot.Box(b[a].map[h][f].h,f,b[a].map.length-h-1)}i===0&&console.error("No light defined in map")}else console.error("Map list is empty")};a.reset=function(){lightBot.bot.reset();for(var a=0;a<d.x;a++)for(var b=0;b<d.y;b++)c[a][b].reset()};
a.ready=function(){return j!==null};a.getLevelSize=function(){return d};a.getMapRef=function(){return c};a.getMedals=function(){return g};a.getLevelNumber=function(){return j};a.getNbrOfLevels=function(){return b.length};a.complete=function(){j=null};lightBot.map=a})();(function(){lightBot.map.backup=[{direction:0,position:{x:4,y:5},map:[[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,
t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"l"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}]],medals:{gold:3,silver:4,bronze:5}},{direction:0,position:{x:2,
...
{h:1,t:"b"},{h:5,t:"l"},{h:4,t:"l"},{h:3,t:"l"},{h:2,t:"l"},{h:1,t:"b"},{h:1,t:"b"}],[{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"}]],medals:{gold:13,silver:16,bronze:26}}]})();(function(){lightBot.map.state={allLightsOn:function(){for(var a=0;a<lightBot.map.getLevelSize().x;a++)for(var b=0;b<lightBot.map.getLevelSize().y;b++)if(lightBot.map.getMapRef()[a][b]instanceof lightBot.LightBox&&!lightBot.map.getMapRef()[a][b].lightOn)return false;return true},check:function(a){return a()}}})();(function(){lightBot.Box=function(a,b,d){this.height=a;this.x=b;this.y=d;this.reset=function(){}}})();(function(){function a(a,d,c){this.lightOn=false;this.height=a;this.x=d;this.y=c;this.toggleLight=function(){this.lightOn=!this.lightOn};this.reset=function(){this.lightOn=false}}a.prototype=new lightBot.Box;a.prototype.constructor=a;lightBot.LightBox=a})();(function(){lightBot.medals={gold:4,silver:3,bronze:2,noMedal:1,awardMedal:function(){var a=lightBot.bot.getNumberOfInstructions(),b=lightBot.map.getMedals(),d=this.noMedal;if(a<=b.gold)d=this.gold;else if(a<=b.silver)d=this.silver;else if(a<=b.bronze)d=this.bronze;(!localStorage.getItem("lightbot_level_"+lightBot.map.getLevelNumber())||parseInt(localStorage.getItem("lightbot_level_"+lightBot.map.getLevelNumber()),10)<d)&&localStorage.setItem("lightbot_level_"+lightBot.map.getLevelNumber(),d);return d}}})();(function(){function a(){for(var a=0,b=0;b<lightBot.map.getNbrOfLevels();b++)localStorage.getItem("lightbot_level_"+b)&&a++;return a}function b(a){for(var b=0,g=0;g<lightBot.map.getNbrOfLevels();g++)localStorage.getItem("lightbot_level_"+g)&&parseInt(localStorage.getItem("lightbot_level_"+g),10)>=a&&b++;return b}lightBot.achievements={achievementsList:[{name:"lightbot_achievement_complete_level",title:"Початківець",message:"Пройшов рівень.",check:function(){return true}},{name:"lightbot_achievement_earn_gold_medal",
title:"Школяр",message:"Має золоту медаль.",check:function(){return lightBot.bot.getNumberOfInstructions()<=lightBot.map.getMedals().gold?true:false}},{name:"lightbot_achievement_complete_levels_5",title:"Амбітний",message:"Пройшов 5 рівнів.",check:function(){return a()>=5?true:false}},{name:"lightbot_achievement_complete_levels_10",title:"Відданий",message:"Пройшов 10 рівнів.",check:function(){return a()>=10?true:false}},{name:"lightbot_achievement_complete_levels_15",title:"Просунутий",message:"Виконав 15 рівнів.",
check:function(){return a()>=15?true:false}},{name:"lightbot_achievement_complete_levels_bronze",title:"Крутий",message:"Earn bronze medals on all levels.",check:function(){return b(lightBot.medals.bronze)===lightBot.map.getNbrOfLevels()}},{name:"lightbot_achievement_complete_levels_silver",title:"Еліта",message:"Отримує срібні медалі на усіх рівнях.",check:function(){return b(lightBot.medals.silver)===lightBot.map.getNbrOfLevels()}},{name:"lightbot_achievement_complete_levels_gold",title:"Майстер",message:"Має золоті медалі на всіх рівнях.",
check:function(){return b(lightBot.medals.gold)===lightBot.map.getNbrOfLevels()}}],hasAchievement:function(a){return localStorage.getItem(a)},awardAchievements:function(){for(var a=[],b=0;b<this.achievementsList.length;b++)!this.hasAchievement(this.achievementsList[b].name)&&this.achievementsList[b].check()&&(localStorage.setItem(this.achievementsList[b].name,true),a.push(this.achievementsList[b]));return a},getAchievementsList:function(){return this.achievementsList}}})();(function(){lightBot.ui={showWelcomeScreen:function(a){lightBot.ui.media.playMenuAudio();a==null&&lightBot.ui.History&&lightBot.ui.History.pushState({page:"welcomeScreen"});$("title").text("СвітлоБот - Вітання");$(".ui-screen").hide();$("#welcomeScreen").show()},showHelpScreen:function(a){lightBot.ui.media.playMenuAudio();a==null&&lightBot.ui.History&&lightBot.ui.History.pushState({page:"helpScreen"});$("title").text("СвтлоБот - Допомога");$(".ui-screen").hide();$("#helpScreen").show()},showAchievementsScreen:function(a){lightBot.ui.media.playMenuAudio();
var b=false;$("#achievementsList").empty();for(var d=lightBot.achievements.getAchievementsList(),c=0;c<d.length;c++)b=lightBot.achievements.hasAchievement(d[c].name)?true:false,$('<li class="'+(b?"":"ui-state-disabled")+'"><img src="img/achievements/'+d[c].name+'.png"><h3>'+d[c].title+"</h3><p>"+d[c].message+"</p></li>").appendTo("#achievementsList");a==null&&lightBot.ui.History&&lightBot.ui.History.pushState({page:"achievementsScreen"});$("title").text("СвітлоБот - Досягнення");$(".ui-screen").hide();
...
$(this).button("option",{label:"Run",icons:{primary:"ui-icon-play"}}).removeClass("ui-state-highlight");else{var a=lightBot.ui.editor.getInstructions($("#programContainer > div > ul > li"));lightBot.bot.queueInstructions(a);lightBot.bot.execute();$(this).button("option",{label:"Стоп",icons:{primary:"ui-icon-stop"}}).addClass("ui-state-highlight")}});$("#clearButton").button({icons:{primary:"ui-icon-document"}}).click(function(){$("#programContainer ul").empty();lightBot.ui.editor.saveProgram()});
